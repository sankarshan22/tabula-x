CREATE TABLE Sheet1(source-Governor VARCHAR(10),source-Party VARCHAR(10),source-Years_in_Office VARCHAR(10),source-Legislatures_as_Governor* VARCHAR(10),target-Governor_s_Name VARCHAR(10),target-State VARCHAR(10),target-Time_in_Office VARCHAR(10),target-Party VARCHAR(10));
INSERT INTO Sheet1 (source-Governor,source-Party,source-Years_in_Office,source-Legislatures_as_Governor*,target-Governor_s_Name,target-State,target-Time_in_Office,target-Party) VALUES 
